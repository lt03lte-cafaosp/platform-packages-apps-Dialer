...
public class CallDetailActivity extends Activity implements ProximitySensorAware {
        ...
        class UpdateContactDetailsTask extends AsyncTask<Void, Void, PhoneCallDetails[]> {
            ...
            public void onPostExecute(PhoneCallDetails[] details) {
                ...
                if (canPlaceCallsTo) {
                    ...
                    // call.
                    final boolean canVTCall = canPlaceCallsTo && (MoreContactUtils.
                            isCSVTSupported() || MoreContactUtils.isImsRegistered()) &&
                            !isSipNumber;
    ...
    private void configureCallButton(ViewEntry entry) {
        ...
        View dividerSub1 = convertView.findViewById(R.id.divider_sub1);
        View dividerSub2 = convertView.findViewById(R.id.divider_sub2);
        ...
        MoreContactUtils.controlCallIconDisplay(context, layoutSub1, callButtonSub1, callIconSub1,
                layoutSub2, callButtonSub2, callIconSub2, dividerSub1,dividerSub2);
